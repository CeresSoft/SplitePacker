...
今まではフリーソフトの「ShoeBox」を便利に使わせていただいてました。
ところがParticleSystemでパーティクルをアニメーションさせようとしたところ
スプライト画像の順番が重要になるのですがShoeBoxではどうしてもスプライト画像の
順番を指定することが出来ず、仕方なく他ツールを探してみたものの良い物が
見つけられなかったので作ってしまいました。
